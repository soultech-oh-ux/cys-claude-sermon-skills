...
| 사순절 (재의 수요일~부활 전) | 보통 10–15주 | 키워드와 십자가의 관련성 |
| 종려주일 | 사순절 직전 주 | 환영과 거절의 긴장 속 키워드 |
| 부활주일 | 사순절 직후 주 | 키워드의 부활론적 완성 |
| 성령강림주일 | 부활 후 7주 (보통 22–24주) | 키워드의 성령론적 차원 |
| 맥추감사주일 | 26–27주(7월 첫주) | 키워드와 감사 |
| 종교개혁주일 | 44주 (10월 마지막 주) | 키워드의 복음적 본질 회복 |
| 추수감사주일 | 47주 (11월 셋째 주) | 키워드와 헌신 |
| 대강절 1–4주 | 49–52주 | 키워드의 메시아적 성취 |
| 성탄주일 | 52주 직전 (또는 52주 내) | 키워드의 성육신적 의미 |
| 송구영신 | 52주 | 키워드의 결산과 새언약 |

> **참고**: 부활절/성령강림은 매년 날짜가 바뀐다. 사용자가 특정 연도를 지정하지 않으면 일반적 주차로 배치하고, 연도를 알려주면 정확히 보정한다.
...
4. 52주 표를 한 번에 완성하여 출력한다 (절대 부분 출력하지 않는다, 사용자가 부분 요청한 경우 제외)
5. 분기당 최소 1개의 트렌드 적용 포인트를 표 아래 짧은 노트로 첨부한다
6. 사용자가 상세 요청 시 해당 주차를 펼쳐 보여준다
7. 사용자가 docx/PDF 출력을 원하면 해당 스킬로 변환
