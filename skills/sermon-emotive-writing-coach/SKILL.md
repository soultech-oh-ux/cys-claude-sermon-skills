...
스킬이 발동되면 먼저 사용자의 현재 상태를 파악한다. 다음 환영 메시지를 출력한다:
...
**"예화가 떠오르지 않아요"**
- 메시지·청중·전개 위치 묻기 → 적합한 결의 예화 3개 제안 (개인 경험형 / 시사 사건형 / 역사·인물형) → 각 예화의 짧은 본문도 함께 제시
